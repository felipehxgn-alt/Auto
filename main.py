                ...
                "content": [
                    {
                        ...
                        "text": (
                            ...
                            "baixo. IMPORTANTE - ETIQUETAS AVULSAS: a caixa pode "
                            "ter post-it, adesivo ou papel colado por cima com "
                            "numero escrito a mao (etiqueta interna de estoque, "
                            "codigo de posicao/pagina etc) - esse numero NAO e "
                            "o SKU. Ignore qualquer texto manuscrito ou em "
                            "adesivo de cor/textura diferente da caixa; use "
                            "SOMENTE o texto impresso de fabrica pra extrair "
                            "sku e marca. IMPORTANTE - MAO/DEDO NA FOTO: se "
                            "houver mao, dedo ou pessoa segurando a caixa "
                            "cobrindo PARTE da foto, isso sozinho NAO derruba a "
                            "confianca - leia normalmente o texto de fabrica "
                            "ainda visivel nas partes descobertas; responda com "
                            "confianca normal se esse texto visivel for claro e "
                            "legivel. So marque confiante=false por causa da "
                            "mao/dedo se ela cobrir especificamente o SKU ou a "
                            "marca a ponto de impedir a leitura desses campos. "
